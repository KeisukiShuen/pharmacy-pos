    ...
    <div class="main-layout">
        ...
        <div class="content">
            <div class="stats-grid">
                <div class="stat-box" style="background: #4e73df;"><small>TOTAL REVENUE</small><div id="stat-rev" style="font-size: 1.4rem; font-weight: bold;">₱0.00</div></div>
            ...
            <div class="card" id="posPage">
                ...
                <div id="cartSection" class="cart-section hidden">
                    ...
                    <div class="cart-total">Total Amount: <span id="grandTotal">₱0.00</span></div>
...
<script>
    ...
    async function loadReports() {
        ...
        data.forEach(r => { 
            total += r[4]; 
            h += `<tr><td>${r[5].substring(0,16)}</td><td>${r[2]}</td><td>${r[3]}</td><td>₱${r[4].toFixed(2)}</td></tr>`; 
        });
